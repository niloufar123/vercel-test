...
import { usePostServiesMutation } from '../../api/Api';
...
function Login() {
    ...
    const [formValues, setFormValues] = React.useState<IFormValue>({ "email": '', password: '' })
                ...
                <div className="bg-white lg:w-6/12 md:7/12 w-8/12 shadow-3xl rounded-xl">
                    ...
                    <div className="p-12 md:p-24" >
                        <div className="flex items-center text-lg mb-6 md:mb-8">
                            ...
                            <InoutCostome name='email' formValues={formValues} setFormValues={setFormValues}  placeholder="Username" />
                        </div>
                        <div className="flex items-center text-lg mb-6 md:mb-8">
